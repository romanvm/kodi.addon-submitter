"""
Django settings for addon_submitter project.
...
SECRET_KEY = 'p-9vib1$soxakgs_6p$r3i*-bxzf@af8st&p99^$bqbjk$**$x'
...
ROOT_URLCONF = 'addon_submitter.urls'
...
WSGI_APPLICATION = 'addon_submitter.wsgi.application'
